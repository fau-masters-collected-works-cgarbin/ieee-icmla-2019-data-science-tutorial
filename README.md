...
- [Answering Questions with Data, bridging the gap between technical analysis and stakeholders point-of-view with Jupyter notebooks](https://github.com/fau-masters-collected-works-cgarbin/intro-data-science-guest-speaker): a lecture delivered as the guest speaker for a the data science class at my [alma mater](https://www.fau.edu/). How to use write Python/Jupyter code that is easy to understand, easy to modify, reliable, and (within reason) is understandable by the stakeholders.
